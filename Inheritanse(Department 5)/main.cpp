...
int main()
{
	...
	Employee* group[] =
	{
		new Monthly("Быканов", "Иван" , "Сборщик роторов", 22, 53000),
		new Hourly("Коротков", "Андрей" , "Ответсвенный за информационную безопасность",158.5, 200),
		new Hourly("Лапенко", "Юрий", "Помощник оператора",50.7,350),
		new Monthly("Хотенцев", "Никоглай", "Мастер цеха",15, 65000),
		new Hourly("Новиков", "Сергей" , "Оператор станков" ,700, 500)
	};
	...
	cout << "Общая зарплата коллектива: " << total_department_salary << " руб.!" << endl;
